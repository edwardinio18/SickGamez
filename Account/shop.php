<?php
	...
	$buyCoinsPaymentSuccesful = "";
	$buyCoinsPaymentCanceled = "";
	
	\Stripe\Stripe::setApiKey('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');
...
<head>
	...
	<link rel="icon" type="image/jpg" href="favicon.jpg" />
  	...
  	<meta name="description" content="Your SickGamez account settings!" />
	...
	<style type="text/css">
        ...
        #shop_coin_amount_user_coin_div {
        ...
        #shop_coin_amount_user_coin_div:hover #shop_coin_amount_user_coin_image {

        	filter: grayscale(0%);

        }

        #shop_coin_amount_user_coin_image {
        ...
        #shop_coin_amount_user_coin_amount {
        ...
        #shop_coin_amount_user_inner_coin_div {
        ...
        .each_shop_item_main_div_title_label_div {
        ...
        .each_shop_item_main_div_buy_label_div {
			...
			border-bottom: 2px solid #777EB8;
			border-right: 2px solid #777EB8;
			border-left: 2px solid #777EB8;
			color: grey;
			font-family: Pixelony;
			font-size: 2.25vw;
        ...
        .each_shop_item_main_div_buy_label_div:active {

        	background-color: white;

        }

        .each_shop_item_image_display {
        ...
        .each_shop_item_main_div_title_label {
	    ...
	    .close_shop_item_modal:hover, .close_shop_item_modal:focus {
	    ...
	    .shop_item_purchase_button_yes:active {

	    	background-color: white;

	    }

	    .shop_item_purchase_button_no {
	    ...
	    .shop_item_purchase_button_no:active {

	    	background-color: white;

	    }

	    .shop_item_modal_product_image_div {
	    ...
	    .each_shop_item_main_div_price_label {
	    ...
	    #each_shop_item_product_price_div {
        ...
        #each_shop_item_product_price_div:hover #each_shop_item_product_price_image {

        	filter: grayscale(0%);

        }

        #each_shop_item_product_price_image {
        ...
        #each_shop_item_product_price_amount {
        ...
        .shop_item_modal_cost_price_outer_div {
        ...
        .shop_item_modal_cost_price_outer_div:hover #shop_item_modal_cost_price_image {

        	filter: grayscale(0%);

        }

        #shop_item_modal_cost_price_image {
        ...
        #shop_item_modal_cost_price_amount {
        ...
        #not_enough_coins_to_buy_modal_container {
	    ...
	    #not_enough_coins_to_buy_modal_content {
	    ...
	    .close_not_enough_coins_to_buy_modal {
	    ...
	    .close_not_enough_coins_to_buy_modal:hover, .close_not_enough_coins_to_buy_modal:focus {
	    ...
	    #not_enough_coins_to_buy_inner_modal_title {
	    ...
	    .not_enough_coins_to_buy_ok_button {
	    ...
	    .not_enough_coins_to_buy_ok_button:active {

	    	background-color: white;

	    }

	    .each_shop_item_main_div_buy_label_div_item_owned {
        ...
        .each_shop_item_main_div_buy_label_div_item_owned_paragraph {
	    ...
	    #buy_coins_button {
			...
			color: grey;
			cursor: default;
			background: url(Images/gold_coin.png) 1.1vw 0.4vw;
	    ...
	    #buy_coins_button:active {

	    	background-color: white;

	    }

	    .buy_coins_modal_container {
	    ...
	    .close_buy_coins_modal:hover, .close_buy_coins_modal:focus {
	    ...
	    #buy_coins_modal_cost_price_outer_div {
        ...
        .buy_coins_modal_cost_price_outer_div:hover #buy_coins_modal_cost_price_image {

        	filter: grayscale(0%);

        }

        #buy_coins_modal_cost_price_image {
        ...
        #buy_coins_modal_cost_price_amount {
        ...
        #buy_coins_main_inner_modal_content_div {
        ...
        .each_buy_coins_price_div:hover .buy_coins_price_image {

        	filter: grayscale(0%);

        }

        .buy_coins_price_image {
        ...
        .buy_coins_div_for_each_main_outer_inner_div {

        	margin-top: 5%;

        }

        .buy_coins_preview_image {
        ...
        .buy_coins_button_bottom_checkout_button {
        ...
        .buy_coins_button_bottom_checkout_button:active {
        ...
        .buy_coins_button_bottom_checkout_button:focus {

        	outline: none;

        }

        .buy_coins_price_label {
        ...
        #buy_coins_payment_made_successful_label {
        ...
        #buy_coins_payment_made_canceled_label {
        ...
        #buy_coins_attention_modal_container {
	    ...
	    #buy_coins_attention_modal_content {
	    ...
	    #close_buy_coins_attention_modal {
	    ...
	    #close_buy_coins_attention_modal:hover, #close_buy_coins_attention_modal:focus {
	    ...
	    #buy_coins_attention_main_title {
	    ...
	    #buy_coins_attention_main_content {
						...
						setInterval(function() {
							...
							xhttp.onreadystatechange = function() {
								...
								if (this.readyState == 4 && this.status == 200) {
									...
									document.getElementById("shop_coin_amount_user_coin_amount").innerHTML = this.responseText;
...
<div id="friends_side_menu" onmouseleave="closeFriendsList()">
	...
	<ul id="social_media_buttons">
  	...
  	<?php
		...
		if (isset($_GET['activity'])) {
			...
			if ($_GET['activity'] == "success") {

				$buyCoinsPaymentSuccesful = "Your purchase has been successfully made!";

				echo "<meta http-equiv='refresh' content='3; url=/Account/shop' />";

			}

			if ($_GET['activity'] == "canceled") {

				$buyCoinsPaymentCanceled = "There was an error processing your purchase, please try again!";
	...
	<p id="buy_coins_payment_made_successful_label"><?php echo $buyCoinsPaymentSuccesful; ?></p>

	<p id="buy_coins_payment_made_canceled_label"><?php echo $buyCoinsPaymentCanceled; ?></p>
	...
	<?php if ($login == 1) : ?>
		...
		<div id="top_right_buy_coins_corner">
  		
	  		<button id="buy_coins_button">Buy coins</button>

	  	</div>

	  	<div id="buy_coins_attention_modal_container">

			<div id="buy_coins_attention_modal_content">

				<span id="close_buy_coins_attention_modal">&times;</span>

				<p id="buy_coins_attention_main_title">! Attention !</p>

				<p id="buy_coins_attention_main_content">Please make sure to use the same email address that you used to create your SickGamez account at checkout when buying coins!</p>

			</div>

		</div>

	  	<div id="buy_coins_modal_container" class="buy_coins_modal_container">

			<div id="buy_coins_modal_content">

				<span class="close_buy_coins_modal">&times;</span>

				<p id="inner_modal_title_buy_coins">Buy coins</p>

				<div id="buy_coins_main_inner_modal_content_div">
					
					<?php

						$buyCoinsList = "";

						$query = "SELECT * FROM buyCoins;";
						...
						if ($result->num_rows >= 1) {
							...
							while ($row = $result->fetch_assoc()) {
								...
								$buyCoinsId = $row['id'];
								$buyCoinsName = $row['buyCoinsName'];
								$buyCoinsAmount = $row['buyCoinsAmount'];
								$buyCoinsImage = $row['buyCoinsImage'];
								$buyCoinsPrice = $row['buyCoinsPrice'];
								$buyCoinsProductIdStripe = $row['buyCoinsProductIdStripe'];
								$buyCoinsPriceApiIdStripe = $row['buyCoinsPriceApiIdStripe'];

								$buyCoinsImageFullPath = "Images/" . $buyCoinsImage;

								$buyCoinsList .= '<div class="buy_coins_main_div_for_each" id="buy_coins_main_div_for_each_' . $buyCoinsId . '">
						
													<p class="buy_coins_div_for_each_title" id="buy_coins_div_for_each_title_' . $buyCoinsId . '">' . $buyCoinsName . '</p>

													<div class="buy_coins_div_for_each_main_outer_inner_div" id="buy_coins_div_for_each_main_outer_inner_div_' . $buyCoinsId . '">
														
														<div class="each_buy_coins_price_div" id="each_buy_coins_price_div_' . $buyCoinsId . '">
													
															<img src="Images/gold_coin.png" class="buy_coins_price_image" />

															<p class="buy_coins_price_amount_label" id="buy_coins_price_amount_label_' . $buyCoinsId . '">' . $buyCoinsAmount . '</p>

														</div>

													</div>

													<img src="' . $buyCoinsImageFullPath . '" class="buy_coins_preview_image" id="buy_coins_preview_image_' . $buyCoinsId . '" />

													<p class="buy_coins_price_label" id="buy_coins_price_label_' . $buyCoinsId . '">€' . $buyCoinsPrice . '</p>

													<div class="buy_coins_button_bottom_div" id="buy_coins_button_bottom_div_' . $buyCoinsId . '">
														
														<button class="buy_coins_button_bottom_checkout_button" id="buy_coins_button_bottom_checkout_button_' . $buyCoinsPriceApiIdStripe . '" style="cursor: default;" data-amount="' . $buyCoinsAmount . '" data-price="' . $buyCoinsPrice . '" data-itemid="' . $buyCoinsId . '" data-productid="' . $buyCoinsProductIdStripe . '" data-productpriceid="' . $buyCoinsPriceApiIdStripe . '">Buy now!</button>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$("#shop_error").remove();
				$("#shop_not_accessible").remove();

			})

		</script>

		<h1 id="shop_label">Shop</h1>

		<div id="shop_coin_amount_user_coin_div">
					
			<div id="shop_coin_amount_user_inner_coin_div">

				<img src="Images/gold_coin.png" id="shop_coin_amount_user_coin_image" />

				<p id="shop_coin_amount_user_coin_amount"></p>

			</div>

		</div>

		<div id="shop_items_outer_main_div">
			
			<?php

				$shopProductsList = "";

				$selectShopProductsQuery = "SELECT * FROM shopProducts ORDER BY shopProductCostPrice ASC;";
				$stmt = $db->prepare($selectShopProductsQuery);
				$stmt->execute();
				$selectShopProductsQueryResult = $stmt->get_result();

				if ($selectShopProductsQueryResult->num_rows >= 1) {

					while ($row = $selectShopProductsQueryResult->fetch_assoc()) {

						$shopProductID = $row['id'];
						$shopProductName = $row['shopProductName'];
						$shopProductImage = $row['shopProductImage'];
						$shopProductImagePath = "Images/" . $shopProductImage;
						$shopProductCostPrice = $row['shopProductCostPrice'];

						$shopProductsList .= '<div class="each_shop_item_main_div" id="each_shop_item_main_div_' . $shopProductID . '">
			
												<div class="each_shop_item_main_div_title_label_div" id="each_shop_item_main_div_title_label_div_' . $shopProductID . '">
													
													<p class="each_shop_item_main_div_title_label" id="each_shop_item_main_div_title_label_' . $shopProductID . '">' . $shopProductName . '</p>

													<div class="each_shop_time_product_price_main_outer_div">
														
														<div id="each_shop_item_product_price_div">

															<img src="Images/gold_coin.png" id="each_shop_item_product_price_image" />

															<p id="each_shop_item_product_price_amount">' . $shopProductCostPrice . '</p>

														</div>

													</div>

													<img src="' . $shopProductImagePath . '" class="each_shop_item_image_display" />

													<div id="each_shop_owned_item_button_div_' . $shopProductID . '">

														<input type="button" style="cursor: default;" class="each_shop_item_main_div_buy_label_div" id="each_shop_item_main_div_buy_label_div_' . $shopProductID . '" data-shopitemid=' . $shopProductID . ' data-shopitemname=' . $shopProductID . ' data-shopitemcostprice=' . $shopProductCostPrice . ' data-shopitemimage=' . $shopProductImagePath . ' value="Purchase item" />
					...
					$shopProductsList = '<p id="empty_products_list">There are currently no products available to buy!</p>';

				}

				echo $shopProductsList;

				$selectOwnedItemsQuery = "SELECT * FROM shopProductsUsersList INNER JOIN shopProducts ON shopProductsUsersList.shopProductsUsersListId = shopProducts.id WHERE shopProductsUsersListUserId = ?;";
				$stmt = $db->prepare($selectOwnedItemsQuery);
				$myID = fetchMyID($_COOKIE['username'], $db);
				$stmt->bind_param("i", $myID);
				$stmt->execute();
				$selectOwnedItemsQueryResult = $stmt->get_result();

				if ($selectOwnedItemsQueryResult->num_rows >= 1) {

					while ($row = $selectOwnedItemsQueryResult->fetch_assoc()) {

						?>

							<script type="text/javascript">

								$("#each_shop_item_main_div_buy_label_div_<?php echo $row["shopProductsUsersListId"] ?>").remove();

								var ownedButtonDiv = '<div class="each_shop_item_main_div_buy_label_div_item_owned"><p class="each_shop_item_main_div_buy_label_div_item_owned_paragraph">Owned</p></div>';

								$("#each_shop_owned_item_button_div_<?php echo $row["shopProductsUsersListId"] ?>").append(ownedButtonDiv);
			...
			<script type="text/javascript">
				...
				function createShopItemContainer(shopItemId, shopItemName, shopItemCostPrice, shopItemImage) {

					var shopItemContainer = '<div id="shop_item_modal_container_' + shopItemId + '" class="shop_item_modal_container">';
					shopItemContainer += '<div id="shop_item_modal_content">';
					shopItemContainer += '<span class="close_shop_item_modal">&times;</span>';
					shopItemContainer += '<p id="inner_modal_title_shop_item">Are you sure you want to purchase this item? <br /> ' + shopItemName + '</p>';
					shopItemContainer += '<div class="shop_item_modal_cost_price_outer_div">';
					shopItemContainer += '<img src="Images/gold_coin.png" id="shop_item_modal_cost_price_image" />';
					shopItemContainer += '<p id="shop_item_modal_cost_price_amount">' + shopItemCostPrice + '</p>';
					shopItemContainer += '</div>';
					shopItemContainer += '<div class="shop_item_modal_product_image_div" style="background-image: url(' + shopItemImage + '); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div>';
					shopItemContainer += '<div id="shop_item_purchase_button_div">';
					shopItemContainer += '<button class="shop_item_purchase_button_yes" id="shop_item_purchase_button_yes" style="cursor: default;">Yes!</button>';
					shopItemContainer += '<button class="shop_item_purchase_button_no" id="shop_item_purchase_button_no" style="cursor: default;">No!</button>';
					shopItemContainer += '</div>';
					shopItemContainer += '</div>';
					shopItemContainer += '</div>';
					$("body").append(shopItemContainer);

				}
				
				$(document).on("click", ".each_shop_item_main_div_buy_label_div", function() {

					var shopItemDivId = $(this).attr("id");
					var shopItemDivData = $(this).data("shopitemid");
					var shopItemNameData = $(this).data("shopitemname");
					var shopItemNameInnerHTMLText = $("#each_shop_item_main_div_title_label_" + shopItemNameData).text();
					var shopItemCostPrice = $(this).data("shopitemcostprice");
					var shopItemImage = $(this).data("shopitemimage");

					createShopItemContainer(shopItemDivId, shopItemNameInnerHTMLText, shopItemCostPrice, shopItemImage);

					var confirmPurchaseItemModal = document.getElementById("shop_item_modal_container_" + shopItemDivId + "");
					var confirmPurchaseItemModalSpan = document.getElementsByClassName("close_shop_item_modal")[0];
					var confirmPurchaseItemModalDivId = confirmPurchaseItemModal.id;

					confirmPurchaseItemModalSpan.onclick = function() {

						confirmPurchaseItemModal.remove();

					}

					$(document).on("click", ".shop_item_purchase_button_no", function() {

						confirmPurchaseItemModal.remove();

					});

					$(document).on("click", ".shop_item_purchase_button_yes", function() {

						$.ajax({

							url: "purchase_shop_product.php",
							method: "GET",
							data: {

								shopItemDivData: shopItemDivData
					...
					$(document).on("click", ".close_not_enough_coins_to_buy_modal", function() {

						$("#not_enough_coins_to_buy_modal_container").remove();
						confirmPurchaseItemModal.remove();

					});

					$(document).on("click", ".not_enough_coins_to_buy_ok_button", function() {
					...
					var notEnoughCoinsToBuyItemModal = document.getElementById("not_enough_coins_to_buy_modal_container");

					window.onclick = function(e) {

						if (e.target == confirmPurchaseItemModal) {
	...
	<?php if ($login == 0) : ?>
		...
		<h1 id="shop_error"><?php $shopError = "Error"; echo $shopError; ?></h1>

		<p id="shop_not_accessible"><?php $shopNotAccessible = "The shop can't be accessed if not logged in!"; echo $shopNotAccessible; ?></p>
...
<?php if ($login == 1) : ?>
	...
	<script type="text/javascript">
		...
		(function() {
		  ...
		  var stripe = Stripe('pk_live_51H3ImyJ8pe0NmgHt2EquIYKH5vcq7vGHXZr3qIeLWIkXJ4q43ei56GfVgRWZreVBU70TrGyEB5OgpHYzONy941Rg00u7zN84q2');

		  var checkoutButton1 = document.getElementById('buy_coins_button_bottom_checkout_button_price_1H5B6HJ8pe0NmgHtzHPLhIa0');
		  checkoutButton1.addEventListener('click', function () {

		    stripe.redirectToCheckout({

		      lineItems: [{price: 'price_1H5B6HJ8pe0NmgHtzHPLhIa0', quantity: 1}],
		      mode: 'payment',
		      successUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=success&product=prod_Hdr06DraR7lU22&price=price_1H5B6HJ8pe0NmgHtzHPLhIa0',
		      cancelUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=canceled&product=prod_Hdr06DraR7lU22&price=price_1H5B6HJ8pe0NmgHtzHPLhIa0',

		    });

		  });

		  var checkoutButton2 = document.getElementById('buy_coins_button_bottom_checkout_button_price_1H5B6kJ8pe0NmgHtCAjnxxLX');
		  checkoutButton2.addEventListener('click', function () {

		    stripe.redirectToCheckout({

		      lineItems: [{price: 'price_1H5B6kJ8pe0NmgHtCAjnxxLX', quantity: 1}],
		      mode: 'payment',
		      successUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=success&product=prod_HdUj3DQlBAG2I9&price=price_1H5B6kJ8pe0NmgHtCAjnxxLX',
		      cancelUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=canceled&product=prod_HdUj3DQlBAG2I9&price=price_1H5B6kJ8pe0NmgHtCAjnxxLX',

		    });

		  });

		  var checkoutButton3 = document.getElementById('buy_coins_button_bottom_checkout_button_price_1H5B73J8pe0NmgHtFLshK141');
		  checkoutButton3.addEventListener('click', function () {

		    stripe.redirectToCheckout({

		      lineItems: [{price: 'price_1H5B73J8pe0NmgHtFLshK141', quantity: 1}],
		      mode: 'payment',
		      successUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=success&product=prod_HdUjgYZGUkDZLW&price=price_1H5B73J8pe0NmgHtFLshK141',
		      cancelUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=canceled&product=prod_HdUjgYZGUkDZLW&price=price_1H5B73J8pe0NmgHtFLshK141',

		    });

		  });

		  var checkoutButton4 = document.getElementById('buy_coins_button_bottom_checkout_button_price_1H5B7WJ8pe0NmgHtJW2Bwyz8');
		  checkoutButton4.addEventListener('click', function () {

		    stripe.redirectToCheckout({

		      lineItems: [{price: 'price_1H5B7WJ8pe0NmgHtJW2Bwyz8', quantity: 1}],
		      mode: 'payment',
		      successUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=success&product=prod_HdUkod53rOeSMn&price=price_1H5B7WJ8pe0NmgHtJW2Bwyz8',
		      cancelUrl: window.location.protocol + '//sickgamez.com/Account/shop?activity=canceled&product=prod_HdUkod53rOeSMn&price=price_1H5B7WJ8pe0NmgHtJW2Bwyz8',
...
<script type="text/javascript">
	...
	$(document).on("click", "#buy_coins_button", function() {

		$("#buy_coins_modal_container").css("display", "block");
		$("#buy_coins_attention_modal_container").css("display", "block");

	});

	$(document).on("click", ".close_buy_coins_modal", function() {

		$("#buy_coins_modal_container").css("display", "none");
		$("#buy_coins_attention_modal_container").css("display", "none");

	});

	$(document).on("click", "#close_buy_coins_attention_modal", function() {
