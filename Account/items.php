<?php
	...
	include("server.php");
	include("/home/yv4nbnligki0/public_html/media_file_duration.php");
...
<head>
	...
	<link rel="icon" type="image/jpg" href="favicon.jpg" />
  	...
  	<meta name="description" content="Your SickGamez funky items!" />
	...
	<style type="text/css">
        ...
        .each_item_main_product_activate_deactivate_div {
        ...
        .each_item_title_label_paragraph {
        ...
        .each_item_main_product_image_div {
        ...
        .each_item_main_product_image_div:hover {

        	opacity: 1;

        }

        .each_item_main_product_activate_div_button {
        ...
        .each_item_main_product_activate_div_button:active {

        	background-color: white;

        }

        .each_item_main_product_deactivate_div_button {
        ...
        .each_item_main_product_deactivate_div_button:active {

        	background-color: white;

        }

        #number_of_items_counter {
        ...
        .each_item_owned_since_when_product_div {
        ...
        .each_item_owned_since_when_product_div_paragraph {
        ...
        .each_item_main_product_deactivate_custom_background_profile_image_div_button {
        ...
        .each_item_main_product_deactivate_custom_background_profile_image_div_button:active {

        	background-color: white;

        }

        .custom_profile_background_image_item_custom_deactivate_button_div {
        ...
        .each_item_main_product_choose_custom_background_profile_image_div_button {

        	display: none;

        }

        .each_item_main_product_choose_custom_background_profile_image_div_button_label {
        ...
        .each_item_main_product_choose_custom_background_profile_image_div_button_label:active {

        	background-color: white;

        }

        .each_item_main_product_set_image_custom_background_profile_image_div_button {
        ...
        .each_item_main_product_set_image_custom_background_profile_image_div_button:active {

        	background-color: white;

        }

        #no_custom_background_image_selected {
        ...
        #no_custom_notifications_sounds_selected {
        ...
        .custom_username_styling_text_item_custom_deactivate_div {
        ...
        .each_item_main_product_deactivate_custom_username_styling_text_div_button {
        ...
        .each_item_main_product_deactivate_custom_username_styling_text_div_button:active {

        	background-color: white;

        }

        .each_item_main_product_choose_custom_username_styling_text_div_button_label {
        ...
        .each_item_main_product_choose_custom_username_styling_text_div_button_label:active {

        	background-color: white;

        }

        .each_item_main_product_set_custom_username_styling_text_div_button {
        ...
        .each_item_main_product_set_custom_username_styling_text_div_button:active {

        	background-color: white;

        }

        #each_item_main_product_choose_custom_username_styling_text_div_button_main_div {

			position: absolute;
			overflow: hidden;
			width: 48.5%;
        	height: 47%;
			border: solid 2.5px #777EB8;
			border-radius: 1vw;
			top: 53%;
			z-index: 1;
        ...
        .each_item_main_product_choose_custom_username_styling_text_div_button {
        ...
        .each_item_main_product_deactivate_custom_notifications_sound_div_button {
        ...
        .each_item_main_product_deactivate_custom_notifications_sound_div_button:active {

        	background-color: white;

        }

        .custom_notifications_sound_item_custom_deactivate_button_div {
        ...
        .each_item_main_product_choose_custom_notifications_sound_div_button {

        	display: none;

        }

        .each_item_main_product_choose_custom_notifications_sound_div_button_label {
        ...
        .each_item_main_product_choose_custom_notifications_sound_div_button_label:active {

        	background-color: white;

        }

        .each_item_main_product_set_image_custom_notifications_sound_div_button {
        ...
        .each_item_main_product_set_image_custom_notifications_sound_div_button:active {
		...
		#allow_autoplay_custom_notifications_sound_modal_container {
	    ...
	    #allow_autoplay_custom_notifications_sound_modal_content {
	    ...
	    .close_allow_autoplay_custom_notifications_sound_modal {
	    ...
	    .close_allow_autoplay_custom_notifications_sound_modal:hover, .close_allow_autoplay_custom_notifications_sound_modal:focus {
	    ...
	    #inner_modal_title_allow_autoplay_custom_notifications_sound {
	    ...
	    #allow_autoplay_custom_notifications_sound_inner_div {
	    ...
	    #inner_modal_title_allow_autoplay_custom_notifications_sound_2 {
	    ...
	    #allow_autoplay_custom_notifications_sound_button {
	    ...
	    #allow_autoplay_custom_notifications_sound_button:active {
...
<div id="friends_side_menu" onmouseleave="closeFriendsList()">
	...
	<?php if ($login == 1) : ?>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$("#items_error").remove();
				$("#items_not_accessible").remove();

			})

		</script>

		<h1 id="items_label">Items</h1>

		<?php

			$noBackgroundImageUploaded = "";
			$currentCustomBackgroundImage = "";
			$currentCustomNotificationsSound = "";
			$noNotificationsSoundUploaded = "";

			if (isset($_POST['each_item_main_product_set_image_custom_notifications_sound_div_button'])) {

				$uploadedCustomNotificationsSound = $_FILES["each_item_main_product_choose_custom_notifications_sound_div_button"]["name"];
				$uploadedCustomNotificationsSoundSource = $_FILES["each_item_main_product_choose_custom_notifications_sound_div_button"]["tmp_name"];
				$uploadedCustomNotificationsSoundType = $_FILES["each_item_main_product_choose_custom_notifications_sound_div_button"]["type"];
				$uploadedCustomNotificationsSoundSize = $_FILES["each_item_main_product_choose_custom_notifications_sound_div_button"]["size"];
				$uploadedCustomNotificationsSoundTargetPath = "/home/yv4nbnligki0/public_html/Notifications_sounds/";

				if (empty($uploadedCustomNotificationsSound)) {

					$noNotificationsSoundUploaded = '<p id="no_custom_notifications_sounds_selected">No media file uploaded!</p>';
					$errors = 1;
				...
				if ($errors == 0) {
					...
					if ($uploadedCustomNotificationsSoundSize > 5242880) {

						$noNotificationsSoundUploaded = '<p id="media_file_size_too_big">Media file can not exceed 5MB!</p>';
						$errors = 1;

					} else {

						$uploadedCustomNotificationsSoundMP3File = new MP3File($uploadedCustomNotificationsSoundSource);

						$uploadedCustomNotificationsSoundMP3FileDuration = $uploadedCustomNotificationsSoundMP3File->getDuration();

						if ($uploadedCustomNotificationsSoundMP3FileDuration > 5) {

							$noNotificationsSoundUploaded = '<p id="media_file_duration_too_long">Media file must not exceed 5 seconds!</p>';
							$errors = 1;

						} else {
						    
						    $selectCurrentCustomNotificationsSoundsQuery = "SELECT * FROM users WHERE username = ?;";
        					$stmt = $db->prepare($selectCurrentCustomNotificationsSoundsQuery);
        					$stmt->bind_param("s", $_COOKIE['username']);
        					$stmt->execute();
        					$selectCurrentCustomNotificationsSoundQueryResult = $stmt->get_result();
        
        					if ($selectCurrentCustomNotificationsSoundQueryResult->num_rows >= 1) {
        
        						if ($row = $selectCurrentCustomNotificationsSoundQueryResult->fetch_assoc()) {
        
        							$currentCustomNotificationsSound = $row['notificationsSound'];
        
        						}
        
        					}
        
        					if ($currentCustomNotificationsSound != "") {
        
        						unlink($uploadedCustomNotificationsSoundTargetPath . $uploadedCustomNotificationsSound);
        
        					}
        
        					$uploadedCustomNotificationsSoundsName = time() . '.mp3';
        
        					move_uploaded_file($uploadedCustomNotificationsSoundSource, $uploadedCustomNotificationsSoundTargetPath . $uploadedCustomNotificationsSoundsName);
        
        					$updateCustomNotificationsSoundsQuery = "UPDATE users SET notificationsSound = ? WHERE username = ?;";
        					$stmt = $db->prepare($updateCustomNotificationsSoundsQuery);
        					$stmt->bind_param("ss", $uploadedCustomNotificationsSoundsName, $_COOKIE['username']);
        					$stmt->execute();
			...
			if (isset($_POST['each_item_main_product_set_custom_username_styling_text_div_button'])) {

				$customChosenColor = $_POST['each_item_main_product_choose_custom_username_styling_text_div_button'];

				$updateCustomUsernameTextStylingQuery = "UPDATE users SET customUsernameTextStyling = ? WHERE username = ?;";
				$stmt = $db->prepare($updateCustomUsernameTextStylingQuery);
				$stmt->bind_param("ss", $customChosenColor, $_COOKIE['username']);
				$stmt->execute();
			...
			if (isset($_POST['each_item_main_product_set_image_custom_background_profile_image_div_button'])) {

				$uploadedCustomProfileBackgroundImage = $_FILES["each_item_main_product_choose_custom_background_profile_image_div_button"]["name"];
				$uploadedCustomProfileBackgroundImageSource = $_FILES["each_item_main_product_choose_custom_background_profile_image_div_button"]["tmp_name"];
				$uploadedCustomProfileBackgroundImageType = $_FILES["each_item_main_product_choose_custom_background_profile_image_div_button"]["type"];
				$uploadedCustomProfileBackgroundImageTargetPath = "/home/yv4nbnligki0/public_html/Background_profile_images/";

				if (empty($uploadedCustomProfileBackgroundImage)) {

					$noBackgroundImageUploaded = '<p id="no_custom_background_image_selected">No image uploaded!</p>';
					$errors = 1;
				...
				if ($errors == 0) {
					...
					$selectCurrentCustomBackgroundQuery = "SELECT * FROM users WHERE username = ?;";
					$stmt = $db->prepare($selectCurrentCustomBackgroundQuery);
					$stmt->bind_param("s", $_COOKIE['username']);
					$stmt->execute();
					$selectCurrentCustomBackgroundQueryResult = $stmt->get_result();

					if ($selectCurrentCustomBackgroundQueryResult->num_rows >= 1) {

						if ($row = $selectCurrentCustomBackgroundQueryResult->fetch_assoc()) {

							$currentCustomBackgroundImage = $row['backgroundProfileImage'];

						}

					}

					if ($currentCustomBackgroundImage != "") {

						unlink($uploadedCustomProfileBackgroundImageTargetPath . $currentCustomBackgroundImage);
						
					}

					$uploadedCustomProfileBackgroundImageName = time() . '.png';

					move_uploaded_file($uploadedCustomProfileBackgroundImageSource, $uploadedCustomProfileBackgroundImageTargetPath . $uploadedCustomProfileBackgroundImageName);

					$updateCustomProfileBackgroundImageQuery = "UPDATE users SET backgroundProfileImage = ? WHERE username = ?;";
					$stmt = $db->prepare($updateCustomProfileBackgroundImageQuery);
					$stmt->bind_param("ss", $uploadedCustomProfileBackgroundImageName, $_COOKIE['username']);
					$stmt->execute();
		...
		<?php
			...
			$itemCounter = 0;
			$shopItemProductName = "";
			$shopItemProductImage = "";
			$shopItemProductImagePath = "";
			$dateAndTimeShopItemProductBought = "";
			$itemsList = "";
			$shopProductActiveStatus = "";
			$activateDeactivateButton = "";
			$customChosenColorFromDB = "";

			$selectCurrentCustomUsernameColorQuery = "SELECT * FROM users WHERE username = ?;";
			$stmt = $db->prepare($selectCurrentCustomUsernameColorQuery);
			$stmt->bind_param("s", $_COOKIE['username']);
			$stmt->execute();
			$selectCurrentCustomUsernameColorQueryResult = $stmt->get_result();

			if ($selectCurrentCustomUsernameColorQueryResult->num_rows >= 1) {

				if ($row = $selectCurrentCustomUsernameColorQueryResult->fetch_assoc()) {

					$customChosenColorFromDB = $row['customUsernameTextStyling'];

				}

			}

			$numberOfItemsCounterQuery = "SELECT * FROM shopProductsUsersList INNER JOIN shopProducts ON shopProductsUsersList.shopProductsUsersListId = shopProducts.id WHERE shopProductsUsersListUserId = ? ORDER BY dateAndTimeShopProductBought DESC;";
			$stmt = $db->prepare($numberOfItemsCounterQuery);
			$myID = fetchMyID($_COOKIE['username'], $db);
			$stmt->bind_param("i", $myID);
			$stmt->execute();
			$numberOfItemsCounterQueryResult = $stmt->get_result();

			if ($numberOfItemsCounterQueryResult->num_rows >= 1) {

				while ($row = $numberOfItemsCounterQueryResult->fetch_assoc()) {

					$shopProductOfficialID = $row['id'];
					$shopProductID = $row['shopProductUsersId'];
					$shopItemProductName = $row['shopProductName'];
					$shopItemProductImage = $row['itemProductImage'];
					$shopItemProductImagePath = "Images/" . $shopItemProductImage;
					$dateAndTimeShopItemProductBought = $row['dateAndTimeShopProductBought'];
					$formattedDateAndTimeShopItemProductBought = date("d/m/Y", strtotime($dateAndTimeShopItemProductBought));
					$shopProductActiveStatus = $row['shopProductsActiveStatus'];

					if ($shopProductActiveStatus == 0) {

						$activateDeactivateButton = '<button class="each_item_main_product_activate_div_button" id="each_item_main_product_activate_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" data-shopproductofficialid="' . $shopProductOfficialID . '" style="cursor: default;">Activate!</button>';

					} else {

						$activateDeactivateButton = '<button class="each_item_main_product_deactivate_div_button" id="each_item_main_product_deactivate_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;">Deactivate!</button>';

					}

					if ($shopProductOfficialID == 1) {

						if ($shopProductActiveStatus == 1) {

							$activateDeactivateButton = '<div class="custom_profile_background_image_item_custom_deactivate_button_div">
												
																<button class="each_item_main_product_deactivate_custom_background_profile_image_div_button" id="each_item_main_product_deactivate_custom_background_profile_image_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;">Deactivate!</button>

																<form action="" method="post" enctype="multipart/form-data" id="choose_and_set_custom_profile_background_image_form">

																	<label for="each_item_main_product_choose_custom_background_profile_image_div_button" class="each_item_main_product_choose_custom_background_profile_image_div_button_label" onclick="chooseCustomBackgroundProfileImage()">Choose!</label>
		
																	<input type="file" class="each_item_main_product_choose_custom_background_profile_image_div_button" id="each_item_main_product_choose_custom_background_profile_image_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;" name="each_item_main_product_choose_custom_background_profile_image_div_button" accept=".png, .jpg, jpeg" />

																	<input type="submit" name="each_item_main_product_set_image_custom_background_profile_image_div_button" class="each_item_main_product_set_image_custom_background_profile_image_div_button" id="each_item_main_product_choose_image_custom_background_profile_image_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;" value="Set!" />
					...
					if ($shopProductOfficialID == 2) {

						if ($shopProductActiveStatus == 1) {

							$activateDeactivateButton = '<div class="custom_username_styling_text_item_custom_deactivate_div">
	
																<button class="each_item_main_product_deactivate_custom_username_styling_text_div_button" id="each_item_main_product_deactivate_custom_username_styling_text_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;">Deactivate!</button>

																<form action="" method="post" id="choose_and_set_custom_username_styling_text_form">
																	
																	<div id="each_item_main_product_choose_custom_username_styling_text_div_button_main_div">
			
																		<input type="color" class="each_item_main_product_choose_custom_username_styling_text_div_button" id="each_item_main_product_choose_custom_username_styling_text_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;" name="each_item_main_product_choose_custom_username_styling_text_div_button" value="' . $customChosenColorFromDB . '" />

																	</div>

																	<input type="submit" name="each_item_main_product_set_custom_username_styling_text_div_button" class="each_item_main_product_set_custom_username_styling_text_div_button" id="each_item_main_product_set_custom_username_styling_text_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;" value="Set!" />
					...
					if ($shopProductOfficialID == 3) {

						if ($shopProductActiveStatus == 1) {

							$activateDeactivateButton = '<div class="custom_notifications_sound_item_custom_deactivate_button_div">
												
																<button class="each_item_main_product_deactivate_custom_notifications_sound_div_button" id="each_item_main_product_deactivate_custom_notifications_sound_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;">Deactivate!</button>

																<form action="" method="post" enctype="multipart/form-data" id="choose_and_set_custom_notifications_sound_form">

																	<label for="each_item_main_product_choose_custom_notifications_sound_div_button" class="each_item_main_product_choose_custom_notifications_sound_div_button_label" onclick="chooseCustomNotificationsSound()">Choose!</label>
		
																	<input type="file" class="each_item_main_product_choose_custom_notifications_sound_div_button" id="each_item_main_product_choose_custom_notifications_sound_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;" name="each_item_main_product_choose_custom_notifications_sound_div_button" accept=".mp3" />

																	<input type="submit" name="each_item_main_product_set_image_custom_notifications_sound_div_button" class="each_item_main_product_set_image_custom_notifications_sound_div_button" id="each_item_main_product_choose_image_custom_notifications_sound_div_button_' . $shopProductID . '" data-shopproductid="' . $shopProductID . '" style="cursor: default;" value="Set!" />
					...
					$itemCounter = mysqli_num_rows($numberOfItemsCounterQueryResult) . " items";

					if ($itemCounter == 1) {

						$itemCounter = mysqli_num_rows($numberOfItemsCounterQueryResult) . " item";

					}

					$itemsList .= '<div class="each_item_main_div">
			
										<div class="each_item_title_label_div">
											
											<p class="each_item_title_label_paragraph">' . $shopItemProductName . '</p>

										</div>

										<div class="each_item_main_product_image_div" style="background-image: url(' . $shopItemProductImagePath . ');"></div>

										<div class="each_item_main_product_activate_deactivate_div">

											<div class="each_item_owned_since_when_product_div">
											
												<p class="each_item_owned_since_when_product_div_paragraph">Bought ' . $formattedDateAndTimeShopItemProductBought . '</p>
				...
				$itemsList = '<p id="empty_items_list">Your items list is currently empty!</p>';

			}

		?>

		<p id="number_of_items_counter"><?php echo $itemCounter; ?></p>

		<div id="main_outer_div_items"><?php echo $itemsList; ?></div>
	...
	<?php if ($login == 0) : ?>
		...
		<h1 id="items_error"><?php $itemsError = "Error"; echo $itemsError; ?></h1>

		<p id="items_not_accessible"><?php $itemsNotAccessible = "Items can't be accessed if not logged in!"; echo $itemsNotAccessible; ?></p>
...
<script type="text/javascript">
	...
	$(document).on("click", ".each_item_main_product_activate_div_button", function() {

		var ownedItemId = $(this).data("shopproductid");
		var shopProductOfficialID = $(this).data("shopproductofficialid");

		if (shopProductOfficialID == 3) {

			$("body").append('<div id="allow_autoplay_custom_notifications_sound_modal_container"><div id="allow_autoplay_custom_notifications_sound_modal_content"><span class="close_allow_autoplay_custom_notifications_sound_modal">&times;</span><div id="allow_autoplay_custom_notifications_sound_inner_div"><p id="inner_modal_title_allow_autoplay_custom_notifications_sound">! Attention !</p><p id="inner_modal_title_allow_autoplay_custom_notifications_sound_2">You must enable sound autoplay within your browser in order for your custom notifications sound to take effect!</p></div><div id="allow_autoplay_custom_notifications_sound_button_div"><button class="allow_autoplay_custom_notifications_sound_button" id="allow_autoplay_custom_notifications_sound_button" style="cursor: default;">Understood!</button></div></div></div>');

			var enableCustomNotificationsSoundModal = document.getElementById("allow_autoplay_custom_notifications_sound_modal_container");
			var enableCustomNotificationsSoundModalSpan = document.getElementsByClassName("close_allow_autoplay_custom_notifications_sound_modal")[0];

			enableCustomNotificationsSoundModalSpan.onclick = function() {

				$.ajax({

					url: "update_activate_item.php",
					method: "GET",
					data: {
			...
			var visibleEnableCustomNotificationsContainer = $("#allow_autoplay_custom_notifications_sound_modal_container").is(":visible");

			if (visibleEnableCustomNotificationsContainer) {

				$(document).bind("keydown", function(e) {

					if (e.keyCode == 13) {

						$("#allow_autoplay_custom_notifications_sound_button").trigger("click");
			...
			$(document).on("click", "#allow_autoplay_custom_notifications_sound_button", function() {
	...
	$(document).on("click", ".each_item_main_product_deactivate_div_button", function() {

		var ownedItemId = $(this).data("shopproductid");

		$.ajax({

			url: "update_deactivate_item.php",
			method: "GET",
			data: {
	...
	$(document).on("click", ".each_item_main_product_deactivate_custom_background_profile_image_div_button", function() {
	...
	$(document).on("click", ".each_item_main_product_deactivate_custom_username_styling_text_div_button", function() {
	...
	$(document).on("click", ".each_item_main_product_deactivate_custom_notifications_sound_div_button", function() {
	...
	function chooseCustomBackgroundProfileImage() {

		document.querySelector(".each_item_main_product_choose_custom_background_profile_image_div_button").click();

	}

	$(".each_item_main_product_choose_custom_background_profile_image_div_button").change(function() {

		var file = $(".each_item_main_product_choose_custom_background_profile_image_div_button")[0].files[0].name;
		$(this).prev("label").text(file);

	});

	function chooseCustomBackgroundUsernameStyling() {

		document.querySelector(".each_item_main_product_choose_custom_username_styling_text_div_button").click();

	}

	function chooseCustomNotificationsSound() {

		document.querySelector(".each_item_main_product_choose_custom_notifications_sound_div_button").click();

	}

	$(".each_item_main_product_choose_custom_notifications_sound_div_button").change(function() {

		var file = $(".each_item_main_product_choose_custom_notifications_sound_div_button")[0].files[0].name;
		$(this).prev("label").text(file);
