...
<head>
	...
	<link rel="icon" type="image/jpg" href="favicon.jpg" />
  	...
  	<meta name="description" content="Search for SickGamez users here and view their profile!" />
	...
	<style type="text/css">
	    ...
	    .profile_pic_search_accounts_display {
...
<div id="sideNav" onmouseleave="closeNav()">
	...
	<h1 id="search_label">Search Accounts</h1>

	<form method="post" id="searchForm" style="text-align: center; margin-top: 6%;">

		<p id="userError"><?php echo $userNonExistent; ?></p>

		<p id="userError"><?php echo $accountUsernameError; ?></p>
		
		<input type="text" name="accountUsername" placeholder="Search by username" class="formInput" <?php if ($errors == 1) echo "style='border: 2.5px solid red;'"; ?> />

		<br />

		<input type="submit" name="searchSubmit" value="Search!" id="search" />

		<br />

		<br />

		<div id="username_link_div">
