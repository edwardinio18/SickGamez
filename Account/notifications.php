...
<head>
	...
	<style type="text/css">
        ...
        .notifications_div_main_div_for_each_div_comment {
        ...
        .profile_pic_display_notifications_div_main_div_for_each_comment {
        ...
        .notifications_div_main_div_for_each_username_comment {
        ...
        .notifications_div_main_div_for_each_username_comment:hover {

        	cursor: pointer;

        }

        .notifications_div_main_div_for_each_content_div_comment {
        ...
        .notifications_div_main_div_for_each_content_comment {
        ...
        .notifications_div_main_div_for_each_content_comment_content {
        ...
        .notifications_div_main_div_for_each_content_date_and_time_comment {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_comment {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_image_comment {
        ...
        .notifications_div_main_div_for_each_div_comment_reply {
        ...
        .profile_pic_display_notifications_div_main_div_for_each_comment_reply {
        ...
        .notifications_div_main_div_for_each_username_comment_reply {
        ...
        .notifications_div_main_div_for_each_username_comment_reply:hover {

        	cursor: pointer;

        }

        .notifications_div_main_div_for_each_content_div_comment_reply {
        ...
        .notifications_div_main_div_for_each_content_comment_reply {
        ...
        .notifications_div_main_div_for_each_content_date_and_time_comment_reply {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_comment_reply {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_image_comment_reply {
        ...
        .notifications_div_main_div_for_each_div_like {
        ...
        .profile_pic_display_notifications_div_main_div_for_each_like {
        ...
        .notifications_div_main_div_for_each_username_like {
        ...
        .notifications_div_main_div_for_each_username_like:hover {

        	cursor: pointer;

        }

        .notifications_div_main_div_for_each_content_div_like {
        ...
        .notifications_div_main_div_for_each_content_like {
        ...
        .notifications_div_main_div_for_each_content_date_and_time_like {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_like {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_image_like {
        ...
        .notifications_div_main_div_for_each_div_follower {
        ...
        .profile_pic_display_notifications_div_main_div_for_each_follower {
        ...
        .notifications_div_main_div_for_each_username_follower {
        ...
        .notifications_div_main_div_for_each_username_follower:hover {

        	cursor: pointer;

        }

        .notifications_div_main_div_for_each_content_div_follower {
        ...
        .notifications_div_main_div_for_each_content_follower {
        ...
        .notifications_div_main_div_for_each_content_date_and_time_follower {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_follower {
        ...
        .notifications_div_main_div_for_each_right_side_image_div_image_follower {
...
<div id="friends_side_menu" onmouseleave="closeFriendsList()">
	...
	<?php if ($login == 1) : ?>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$("#notifications_error").remove();
				$("#notifications_not_accessible").remove();

			})

		</script>

		<h1 id="notifications_label">Notifications</h1>

		<div id="notifications_mark_all_as_read_div"></div>

		<div id="notifications_list_div"></div>
	...
	<?php if ($login == 0) : ?>
		...
		<h1 id="notifications_error"><?php $notificationsError = "Error"; echo $notificationsError; ?></h1>

		<p id="notifications_not_accessible"><?php $notificationsNotAccessible = "Notifications can't be accessed if not logged in!"; echo $notificationsNotAccessible; ?></p>
		...
		setInterval(function() {
			...
			xhttp.onreadystatechange = function() {
				...
				if (this.readyState == 4 && this.status == 200) {
					...
					document.getElementById("notifications_list_div").innerHTML = this.responseText;

				}

			};

			xhttp.open("GET", "notifications_page_ajax_refresh.php", true);
		...
		setInterval(function() {
			...
			xhttp.onreadystatechange = function() {
				...
				if (this.readyState == 4 && this.status == 200) {
					...
					document.getElementById("notifications_mark_all_as_read_div").innerHTML = this.responseText;
