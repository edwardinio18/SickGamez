    ...
    if (isset($_POST['reset_password'])) {
    	...
    	if (empty($email)) {
    		...
    		if ($stmt->num_rows == 0) {
    			...
    			$emailDoesNotExist = "An account linked with this email address could not be found!";
    			$errors = 1;
    	...
    	if ($errors == 0) {
    		...
    		$url = "https://www.sickgamez.com/Account/create_new_password?selector=" . $selector . "&validator=" . $token;
            ...
            $to = $email;
            $subject = "Reset your SickGamez password";
            $message = '<html><body>';
            $message .= '<p>To reset your SickGamez password just click the link below! If this action was not requested by you, you can ignore this email!</p>';
            $message .= '<br />';
            $message .= '<p>';
            $message .= '<a href="' . $url . '">Reset your SickGamez password</a>';
            $message .= '</p>';
            ...
            if (mail($to, $subject, $message, $headers)) {
                ...
                $resetPasswordEmailSentSuccessfully = "An email with a reset link has been sent out! Check your inbox!";
    		    $redirectToLoginPage = "You will now be redirected back to the login page!";  
    		  
    		    header("refresh:3; url=log_in");
                
            } else {
                
                $resetPasswordEmailSentFailed = "An error occured! Please try again!";
                
                echo "<meta http-equiv='refresh' content='3; url=forgot_password' />";
...
<head>
	...
	<link rel="icon" type="image/jpg" href="favicon.jpg" />
  	...
  	<meta name="description" content="Forgot your SickGamez password?" />
...
<div id="sideNav" onmouseleave="closeNav()">
	...
	<h1 id="forgot_password_label">Forgot password</h1>

	<p id="reset_password_email_sent_successfully"><?php echo $resetPasswordEmailSentSuccessfully; ?></p>
	
	<p id="reset_password_email_sent_failed"><?php echo $resetPasswordEmailSentFailed; ?></p>

	<p id="redirect_back_to_login_page"><?php echo $redirectToLoginPage; ?></p>

	<form action="forgot_password" method="post" style="text-align: center; margin-top: 8%;">
		...
		<input type="submit" name="reset_password" id="reset_password" value="Send reset password link!" />

	</form>

	<div id="back_arrow_div">
			
			<a href="log_in" id="back_arrow_link">
