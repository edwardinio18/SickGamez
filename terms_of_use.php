...
<body>
	...
	<p id="sidenav_name"><a class="sidenav_name_link" href="index">SickGamez</a></p>
  	...
  	<ul id="menu_buttons_list">
    	...
    	<li><a class="menu_buttons" id="log_in_link" href="Account/log_in?redirect=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" style="padding: 8px 8px 8px 32px; text-decoration: none; font-size: 27px; display: block; transition: 0.3s; margin-left: -15%;">Log in</a></li>
	...
	<h1 id="terms_of_use_label">Terms of use</h1>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">These terms of use outline the rules and regulations for the use of SickGamez, which can be found at sickgamez.com.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">By accessing this website we assume that you accept our terms of use. Do not use SickGamez if you do not agree to all of the terms of use on this page.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">The following terminology applies to these terms of use, privacy statement and disclaimer notice and all agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to SickGamez's terms of use. "The company", "Ourselves", "We", "Our" and "Us", refers to SickGamez. "Party", "Parties", or "Us", refers to both the client and ourselves. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>

	</div>

	<h2 class="terms_of_use_subtitle">Cookies</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">We use cookies on our website to deliver the best possible experience for all of our users. By accessing SickGamez, you agreed to use cookies in agreement with SickGamez's privacy policy.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">Cookies are used by SickGamez in order to enable features on the website for already existing users and all newcomers.</p>

	</div>

	<h2 class="terms_of_use_subtitle">License</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">Unless otherwise stated, SickGamez and/or its licensors own the intellectual property rights for all material on sickgamez.com. All intellectual property rights are reserved. You may access this from sickgamez.com for your own personal use subjected to restrictions set in these terms of use.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">You must not:</p>

		<ul class="terms_of_use_list">
			
			<li class="terms_of_use_list_items">Replenish material from sickgamez.com</li>

			<li class="terms_of_use_list_items">Sell, rent or sub-license material from sickgamez.com</li>

			<li class="terms_of_use_list_items">Reproduce, duplicate or copy material from sickgamez.com</li>

			<li class="terms_of_use_list_items">Redistribute content from sickgamez.com</li>
	...
	<div class="terms_of_use_div">
		...
		<p class="terms_of_use_content">This agreement shall begin on the date hereof.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">Parts of this website offer an opportunity for users to write posts on their own personal profile and by doing this, creating the possibility of exchanging opinions with other users. Posts created by a user can be seen by anyone accessing the website, whether they have signed up for an account or not. SickGamez does not filter, edit, publish, or review posts prior to their presence on the website and to the public. Posts created by users do not reflect the views and opinions of SickGamez, its agents and/or affiliates. Posts reflect the views and opinions of the user who wrote that specific post. To the extent permitted by applicable laws, SickGamez shall not be liable for the posts created by users or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the posts on this website.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">SickGamez reserves the right to monitor all posts created by users and to remove any posts created by users which are considered inappropriate, offensive or causes breach of these terms of us.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">You warrant and represent that:</p>

		<ul class="terms_of_use_list">
			
			<li class="terms_of_use_list_items">You are entitled to create posts on our website and have all necessary licenses and consents to do so;</li>

			<li class="terms_of_use_list_items">The posts created by users do not invade any intellectual property right, including without limitation copyright, patent or trademark of any third party;</li>

			<li class="terms_of_use_list_items">The posts created by users do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an invasion of privacy;</li>

			<li class="terms_of_use_list_items">The posts created by users will not be used to solicit or promote business or custom or present commercial activities or unlawful activity.</li>

		</ul>

	</div>

	<h2 class="terms_of_use_subtitle">Hyperlinking to our content</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">The following organizations may link to sickgamez.com without prior written approval:</p>

		<ul class="terms_of_use_list">
			
			<li class="terms_of_use_list_items">Government agencies;</li>

			<li class="terms_of_use_list_items">Search engines;</li>

			<li class="terms_of_use_list_items">Online directory distributors may link to sickgamez.com in the same manner as they hyperlink to the websites of other listed businesses; and</li>

			<li class="terms_of_use_list_items">Third party businesses affiliated/not affiliated with SickGamez may link to sickgamez.com.</li>
	...
	<div class="terms_of_use_div">
		...
		<p class="terms_of_use_content">These organizations may link to any page on our website, to publications and to other website information so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or services; and (c) fits within the context of the linking party's site.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">We may consider and approve other link requests from the following types of organizations:</p>

		<ul class="terms_of_use_list">
			
			<li class="terms_of_use_list_items">Commonly-known consumer and/or business information sources;</li>

			<li class="terms_of_use_list_items">Dot.com community sites;</li>

			<li class="terms_of_use_list_items">Associations or other groups representing charities;</li>

			<li class="terms_of_use_list_items">Online directory distributors;</li>

			<li class="terms_of_use_list_items">Internet portals;</li>

			<li class="terms_of_use_list_items">Accounting, law and consulting firms; and</li>

			<li class="terms_of_use_list_items">Educational institutions and trade associations.</li>
	...
	<div class="terms_of_use_div">
		...
		<p class="terms_of_use_content">We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavourably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of SickGamez; and (d) the link is in the context of general resource information.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or services; and (c) fits within the context of the linking party's site.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an email to sssickgamezzz@gmail.com. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to SickGamez, and a list of the URLs on our site to which you would like to link. We'll get back to you as soon as we can.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">Approved organizations may hyperlink to sickgamez.com as follows:</p>

		<ul class="terms_of_use_list">
			
			<li class="terms_of_use_list_items">By use of our corporate name; or</li>

			<li class="terms_of_use_list_items">By use of the uniform resource locator being linked to; or</li>

			<li class="terms_of_use_list_items">By use of any other description of sickgamez.com being linked to that makes sense within the context and format of content on the linking party's site.</li>
	...
	<div class="terms_of_use_div">
		...
		<p class="terms_of_use_content">No use of SickGamez's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>

	</div>

	<h2 class="terms_of_use_subtitle">iFrames</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">Without prior approval and written permission, you may not create frames around our webpages that alter in any way the visual presentation or appearance of our sickgamez.com.</p>

	</div>

	<h2 class="terms_of_use_subtitle">Content liability</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">We shall not be held responsible for any content created and uploaded by users that appears on sickgamez.com. You agree to protect and defend us against all claims that is rising on sickgamez.com. No link(s) should appear on any website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">By agreeing to our terms of use, any game that is submitted to our website shall be reviewed in full by our team and if deemed inappropriate in any way, the submission process will be terminated and if there is a known uploader for the game, they shall be contacted in relation to the game.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">If the game submission process is completed successfully, that specific game will be available to play on the website starting from that moment on until the respective owner, if known, decides to take it down. The uploader of that game is in full possession of their game and have the right to personally decide how to handle the game. Each game uploader recevies full credits for their uploaded game and its contents.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">SickGamez members are also offered the chance to upload their own profile picture, which can be seen across various pages on the website. SickGamez does not filter, edit, publish, or review uploaded profile pictures prior to their presence on the website and to the public.</p>

	</div>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">SickGamez reserves the right to monitor all profile pictures uploaded by users and to remove any profile pictures uploaded by users which are considered inappropriate, offensive or causes breach of these terms of use.</p>

	</div>

	<h2 class="terms_of_use_subtitle">Reservation of rights</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">We reserve the right to request that you remove all links to any particular link to sickgamez.com. You approve to immediately remove all links to sickgamez.com upon request. We also reserve the right to amen these terms of use and its linking policy at any time. By continuously linking to sickgamez.com, you agree to be bound to and follow these linking terms and conditions.</p>

	</div>

	<h2 class="terms_of_use_subtitle">Removal of links from our website</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">If you find any link on sickgamez.com that is offensive for any reason, you are free to contact and inform us at any given time. We will review requests to remove links but we are not obligated to or so or to respond to you directly.</p>

	</div>

	<h2 class="terms_of_use_subtitle">Disclaimer</h2>

	<div class="terms_of_use_div">

		<p class="terms_of_use_content">To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our website and the use of this website. Nothing in this disclaimer will:</p>

		<ul class="terms_of_use_list">
			
			<li class="terms_of_use_list_items">Limit or exclude our or your liability for death or personal injury;</li>

			<li class="terms_of_use_list_items">Limit or exclude our or your liability for fraud or fraudulent misrepresentation;</li>

			<li class="terms_of_use_list_items">Limit any of our or your liabilities in any way that is not permitted under applicable law; or</li>

			<li class="terms_of_use_list_items">Exclude any of our or your liabilities that may not be excluded under applicable law.</li>
	...
	<div class="terms_of_use_div">
		...
		<p class="terms_of_use_content">As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.</p>

	</div>

	<div id="copyright_footer_div">
		
		<p>&copy; Copyright 2020 SickGamez All Rights Reserved</p>

	</div>

	<div id="back_arrow_div">
		
		<a href="about" id="back_arrow_link">
		
			<img src="Account/Images/back_arrow.png" id="back_arrow_image" />
