...
<head>
	...
	<link rel="icon" type="image/jpg" href="favicon.jpg" />
  	...
  	<meta name="description" content="This game has been published by a fellow SickGamer!" />
	...
	<style type="text/css">
	    ...
	    #not_logged_in_like:hover {

	    	opacity: 1;

	    }

	    #not_logged_in_dislike {
	    ...
	    #not_logged_in_dislike:hover {

	    	opacity: 1;

	    }

	    #not_logged_in_like_dislike_modal_container {
	    ...
	    #not_logged_in_like_dislike_modal_content {
	    ...
	    .close_not_logged_in_like_dislike_modal {
	    ...
	    .close_not_logged_in_like_dislike_modal:hover, .close_not_logged_in_like_dislike_modal:focus {
	    ...
	    .log_in_not_logged_in_button:active {

	    	background-color: white;

	    }

	    .sign_up_not_logged_in_button {
	    ...
	    .sign_up_not_logged_in_button:active {
...
<div id="sideNav" onmouseleave="closeNav()">
	...
	<div id="submit_feed_post_modal_container">
				
		<div id="submit_feed_post_modal_content">
			
			<span class="close_submit_feed_post_modal">&times;</span>

			<div id="form_outer_submit_feed_post_div">

				<div id="submit_feed_post_image_preview_div"></div>

				<p id="no_uploaded_feed_post_image">No image has been uploaded!</p>

				<form action="" method="post" enctype="multipart/form-data" id="submit_feed_post_form">

					<textarea id="submit_feed_post_caption_textarea" maxlength="350" class="submit_feed_post_caption_textarea" name="submit_feed_post_caption_textarea" placeholder="Add a caption!" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Add a caption!'"></textarea>

					<div id="submit_feed_post_inner_div">

						<label for="upload_feed_post_image" class="upload_feed_post_label">

							<span id="upload_feed_post_image_label_span">

								<img src="Images/image_placeholder.png" id="upload_feed_post_image_span_image" />

							</span>

						</label>

						<input type="file" name="upload_feed_post_image" id="upload_feed_post_image" class="upload_feed_post_image" accept=".png, .jpg, .jpeg" />

						<input type="submit" name="submit_feed_post_caption_submit_button" id="submit_feed_post_caption_submit_button" class="submit_feed_post_caption_submit_button" value="Submit!" />
	...
	<div id="main_outer_feed_div">
		...
		<?php
			...
			$query = "SELECT * FROM feed INNER JOIN users ON feed.feedUserId = users.id ORDER BY dateAndTimeFeedSubmitted DESC;";
	...
	<?php if ($login == 1) : ?>
		...
		<div id="submit_feed_post_main_outer_div_bottom">
			
			<img src="Images/plus.png" id="submit_feed_post_main_outer_div_bottom_plus_image" />

			<p id="submit_feed_post_main_outer_div_bottom_main_text">Submit a post to the feed!</p>
...
<?php if ($login == 1) : ?>
	...
	<script type="text/javascript">
		...
		$("#upload_feed_post_image").change(function(e) {

			$("#no_uploaded_feed_post_image").css("display", "none");

			$(".upload_feed_post_label").removeClass("no_uploaded_feed_post_image_label");
			$(".upload_feed_post_label").removeClass("uploaded_image_too_large");

			$("#submit_feed_post_image_preview_div").css("border-top", "2.5px solid #777EB8");
			$("#submit_feed_post_image_preview_div").css("border-right", "2.5px solid #777EB8");
			$("#submit_feed_post_image_preview_div").css("border-left", "2.5px solid #777EB8");

			$("#uploaded_image_too_large_error").css("display", "none");

			if ($("#no_uploaded_feed_post_image").is(":visible")) {
			...
			var file = $("#upload_feed_post_image")[0].files[0].name;

			tmpPath = URL.createObjectURL(e.target.files[0]);

			$("#submit_feed_post_image_preview_display").attr("src", tmpPath);

			if (!($("#submit_feed_post_image_preview_div").is(":visible"))) {

				$("#submit_feed_post_image_preview_div").css("display", "block");

				$("#submit_feed_post_image_preview_div").append('<span class="close_zoomed_in_submit_feed_post_image_cover_div_modal" id="close_zoomed_in_submit_feed_post_image_cover_div_modal">&times;</span><img src="' + tmpPath + '" id="submit_feed_post_image_preview_display" /><p id="uploaded_image_too_large_error">Image can\'t exceed 5MB!</p>');

			}

		});

		$(document).on("click", ".close_zoomed_in_submit_feed_post_image_cover_div_modal", function() {
			...
			$("#submit_feed_post_image_preview_display").remove();

			$(".close_zoomed_in_submit_feed_post_image_cover_div_modal").remove();

			$("#submit_feed_post_image_preview_div").css("display", "none");

			document.getElementById("upload_feed_post_image").value = document.getElementById("upload_feed_post_image").defaultValue;

		});

		$(document).on("submit", "#submit_feed_post_form", function(e) {

			e.preventDefault();
			e.stopImmediatePropagation();

			var feedPostTextareaContent = $("#submit_feed_post_caption_textarea").val();
			var feedPostTextareaContentTrimmed = feedPostTextareaContent.trim();
			var feedPostTextareaContentTrimmedLength = feedPostTextareaContentTrimmed.length;

			var uploadedFeedPostImageFileLength = document.getElementById("upload_feed_post_image").files.length;
			var uploadedFeedPostImageFile = $("#upload_feed_post_image")[0].files;

			if (uploadedFeedPostImageFileLength == 0) {

				$(".upload_feed_post_label").addClass("no_uploaded_feed_post_image_label");
				$("#no_uploaded_feed_post_image").css("display", "block");
				$("#submit_feed_post_image_preview_div").css("border-top", "2.5px solid red");
				$("#submit_feed_post_image_preview_div").css("border-right", "2.5px solid red");
				$("#submit_feed_post_image_preview_div").css("border-left", "2.5px solid red");
				...
				$.ajax({
					...
					url: "submit_feed_post_content_into_db.php",
					type: "POST",
					data: formData,
					cache: false,
					contentType: false,
					...
					success: function(data) {
						...
						if (data === "1") {
							...
							$(".upload_feed_post_label").addClass("uploaded_image_too_large");
							...
							$("#submit_feed_post_image_preview_display").remove();
							$("#close_zoomed_in_submit_feed_post_image_cover_div_modal").remove();
							$("#uploaded_image_too_large_error").remove();
							...
							$("#submit_feed_post_caption_textarea").val("");

							$("#submit_feed_post_image_preview_div").css("display", "none");

							$("#submit_feed_post_caption_textarea").blur();
							...
							$("#submit_feed_post_modal_container").css("display", "none");
		...
		function getAllFeedScroll(limit, start) {

			$.ajax({

				url: "get_all_feed_scroll.php",
				method: "GET",
				data: {
		...
		$(window).scroll(function() {
			...
			if ($(window).scrollTop() + $(window).height() > $("#main_outer_feed_div").height() && action == "inactive") {
				...
				getAllFeedScroll(limit, start);

			}

		});

		function getAllFeed(limit, start) {
		...
		$(document).on("click", ".feed_post_comments_each_div_comment_content_view_replies", function() {
			...
			$.ajax({
				...
				url: "get_all_feed_comments_replies.php",
				method: "GET",
				data: {
						...
						success: function(data) {
							...
							if (data === "1") {
								...
								$.ajax({
									...
									url: "get_all_feed_comments_after_insert_reply_result.php",
									method: "GET",
									data: {
						...
						success: function(data) {
							...
							if (data === "1") {
								...
								$.ajax({
									...
									url: "get_all_feed_comments_after_delete_result.php",
									method: "GET",
									data: {
		...
		$(document).ready(function() {
			...
			$(document).on("click", "#submit_feed_post_main_outer_div_bottom", function() {

				$("#submit_feed_post_modal_container").css("display", "block");
				$("body").css("overflow", "hidden");
		...
		var submitFeedPostModal = document.getElementById("submit_feed_post_modal_container");
		var submitFeedPostModalSpan = document.getElementsByClassName("close_submit_feed_post_modal")[0];

		submitFeedPostModalSpan.onclick = function() {

			submitFeedPostModal.style.display = "none";
			$("body").css("overflow", "auto");
			$("#no_uploaded_feed_post_image").css("display", "none");
			$(".upload_feed_post_label").removeClass("no_uploaded_feed_post_image_label");
			$(".upload_feed_post_label").removeClass("uploaded_image_too_large");
		...
		window.onclick = function(e) {
			...
			if (e.target == submitFeedPostModal) {
		...
		$("html").bind("keydown", function(e) {
			...
			if (e.keyCode === 27) {
				...
				if ($("#submit_feed_post_modal_container").is(":visible")) {
...
<?php if ($login == 0) : ?>
	...
	<script type="text/javascript">
		...
		$(document).on("click", ".hide_comments_feed_div_for_each", function() {
			...
			$("#comment_view_comments_feed_div_for_each_inner_bottom_div_" + feedID).append('<p class="view_comments_feed_div_for_each" style="padding: 0.2vw;" id="view_comments_feed_div_for_each_' + feedID + '" data-feedid="' + feedID + '" data-feedpostcommentcount="' + feedPostCommentCount + '">View comments (' + feedPostCommentCount + ')</p>');
