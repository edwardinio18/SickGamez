<?php
	...
	$selectGameInfoQuery = "SELECT * FROM gamez WHERE gameId = ? AND activeStatus = ?;";
	$stmt = $db->prepare($selectGameInfoQuery);
	$activeStatus = 1;
	$stmt->bind_param("si", $gameID, $activeStatus);
	$stmt->execute();
	$selectGameInfoQueryResult = $stmt->get_result();

	if (!isset($_GET['id'])) {

		$leaderboardNotFoundError = "Error";
		$leaderboardNotFound = "No game leaderboard linked with the provided id in the URL exists!";
	...
	if (isset($_GET['id'])) {
		...
		if ($selectGameInfoQueryResult->num_rows > 0) {

			if ($row = $selectGameInfoQueryResult->fetch_assoc()) {
...
<head>
	...
	<link rel="icon" type="image/jpg" href="favicon.jpg" />
  	...
  	<meta name="description" content="Game leaderboards are presented on this page!" />
	...
	<style type="text/css">
	    ...
	    #leaderboard_first_place_main_div {
	    ...
	    #leaderboard_first_place_left_div {
	    ...
	    #leaderboard_first_place_left_div_paragraph {
	    ...
	    #leaderboard_first_place_right_div {
	    ...
	    .leaderboard_profile_pic_and_username_div {
	    ...
	    .profile_picture_display_leaderboard_right_div {
	    ...
	    .leaderboard_username_right_div {
	    ...
	    .leaderboard_username_right_div_paragraph {
	    ...
	    .leaderboard_username_right_div_paragraph:hover {

	    	text-decoration: underline;

	    }

	    .leaderboard_username_and_timer_line_break {
	    ...
	    .leaderboard_timer_div_paragraph {
	    ...
	    .leaderboard_timer_div_paragraph_content {
	    ...
	    .leaderboard_timer_and_deaths_line_break {
	    ...
	    .leaderboard_deaths_div_paragraph {
	    ...
	    .leaderboard_deaths_div_paragraph_content {
	    ...
	    #leaderboard_second_place_main_div {
	    ...
	    #leaderboard_second_place_left_div {
	    ...
	    #leaderboard_second_place_left_div_paragraph {
	    ...
	    #leaderboard_second_place_right_div {
	    ...
	    #leaderboard_third_place_main_div {
	    ...
	    #leaderboard_third_place_left_div {
	    ...
	    #leaderboard_third_place_left_div_paragraph {
	    ...
	    #leaderboard_third_place_right_div {
	    ...
	    .leaderboard_all_after_third_place_main_div {
	    ...
	    .leaderboard_all_after_third_place_left_div {
	    ...
	    .leaderboard_all_after_third_place_left_div_paragraph {
	    ...
	    .leaderboard_all_after_third_place_right_div {
	    ...
	    .leaderboard_date_and_time_right_div {
	    ...
	    .leaderboard_date_and_time_right_div_paragraph {
...
<div id="sideNav" onmouseleave="closeNav()">
	...
	<h1 id="leaderboard_for_label">Leaderboard for <?php echo $gameName; ?></h1>

	<div id="leaderboard_main_div">

		<?php

			$leaderboardFirstThreePlacesListEmpty = "";

			$query = "SELECT * FROM xubeGameData;";
			...
			if ($result->num_rows == 0) {
				...
				$leaderboardFirstThreePlacesListEmpty = '<p id="leaderboard_empty">The leaderboard for this game is currently empty!</p>';
			...
			echo $leaderboardFirstThreePlacesListEmpty;

		?>
		
		<div id="leaderboard_top_div"></div>

		<div id="leaderboard_bottom_div"></div>

	</div>

	<div id="back_arrow_div">
		
		<a href="gamez" id="back_arrow_link">
	...
	<?php if ($login == 0 && $selectGameInfoQueryResult->num_rows == 0) : ?>

		<h1 id="leaderboard_not_found_error"><?php echo $leaderboardNotFoundError; ?></h1>

		<p id="leaderboard_not_found"><?php echo $leaderboardNotFound; ?></p>

		<script type="text/javascript">
			
			$(document).ready(function() {

				$("#leaderboard_for_label").remove();
				$("#leaderboard_main_div").remove();
	...
	<?php if ($login == 1 && $selectGameInfoQueryResult->num_rows == 0) : ?>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		updateAllLeaderboardStatsFirstThree();
		updateAllLeaderboardStatsAfterFirstThree();
	...
	function fetchAllLeaderboardStatsFirstThree() {

		$.ajax({

			url: "get_all_leaderboard_stats_first_three.php",
			method: "GET",
			success: function(data) {

				$("#leaderboard_top_div").html(data);
	...
	function updateAllLeaderboardStatsFirstThree() {

		$("#leaderboard_top_div").each(function() {

			fetchAllLeaderboardStatsFirstThree();

		});

	}

	function fetchAllLeaderboardStatsAfterFirstThree() {

		$.ajax({

			url: "get_all_leaderboard_stats_after_first_three.php",
			method: "GET",
			success: function(data) {

				$("#leaderboard_bottom_div").html(data);
	...
	function updateAllLeaderboardStatsAfterFirstThree() {

		$("#leaderboard_bottom_div").each(function() {

			fetchAllLeaderboardStatsAfterFirstThree();
