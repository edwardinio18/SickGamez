...
<body>
	...
	<h1 id="privacy_policy_label">Privacy policy</h1>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">At SickGamez, accessible at sickgamez.com, one of our main priorities and concern is the privacy of our users. This privacy policy document contains types of information that is collected and recorded by SickGamez and how we use it.</p>

	</div>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">This privacy policy applies to our online activities and is valid for users to our website with regards to the information that they shared and/or collected from sickgamez.com. This policy is not applicable to any information collected offline or via channels other than this website.</p>

	</div>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">If you have additional questions or require more information about our privacy policy, do not hesitate to contact us through email at sssickgamezzz@gmail.com</p>

	</div>

	<h2 class="privacy_policy_subtitle">Consent</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">By using our website, you hereby consent to our privacy policy and agree to all of its terms.</p>

	</div>

	<h2 class="privacy_policy_subtitle">Information we collect</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point when we ask you to provide your personal information.</p>

	</div>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">If you contact us directly, we may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.</p>

	</div>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">When you sign up for an account, you will be asked to provide your email address.</p>

	</div>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">We will never share out any of your information.</p>

	</div>

	<h2 class="privacy_policy_subtitle">How we use your information</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">We use the information we collect in various ways, including to:</p>

		<ul class="privacy_policy_list">
			
			<li class="privacy_policy_list_items">Provide, operate, and maintain our website.</li>

			<li class="privacy_policy_list_items">Improve, personalize, and expand our website.</li>

			<li class="privacy_policy_list_items">Understand and analyze how you use our website.</li>

			<li class="privacy_policy_list_items">Develop new products, services, features, and functionality.</li>

			<li class="privacy_policy_list_items">Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes.</li>

			<li class="privacy_policy_list_items">Send you emails.</li>

			<li class="privacy_policy_list_items">Find and prevent fraud.</li>

		</ul>

	</div>

	<h2 class="privacy_policy_subtitle">Cookies and web beacons</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">Like any other website, sickgamez.com uses cookies. These cookies are used to store data such as information about a logged in user and in doing so, making available certain features to that particular user on the website.</p>

	</div>

	<h2 class="privacy_policy_subtitle">GDPR privacy policy</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">We would like to make sure that you are fully aware of all of your data protection rights. Every user is entitled to the following:</p>

		<ul class="privacy_policy_list">
			
			<li class="privacy_policy_list_items">The right to access - You have the right to request copies of your personal data.</li>

			<li class="privacy_policy_list_items">The right to rectification - You have the right to request that we correct any information you believe is inaccurate. You also have the right to request that we complete the information you believe is incomplete.</li>

			<li class="privacy_policy_list_items">The right to erasure – You have the right to request that we erase your personal data, under certain conditions.</li>

			<li class="privacy_policy_list_items">The right to restrict processing – You have the right to request that we restrict the processing of your personal data, under certain conditions.</li>

			<li class="privacy_policy_list_items">The right to object to processing – You have the right to object to our processing of your personal data, under certain conditions.</li>

			<li class="privacy_policy_list_items">The right to data portability – You have the right to request that we transfer the data that we have collected to another organization, or directly to you, under certain conditions.</li>
	...
	<div class="privacy_policy_div">
		...
		<p class="privacy_policy_content">If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>

	</div>

	<h2 class="privacy_policy_subtitle">CCPA privacy policy</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">Under the CCPA, among other rights, California consumers have the right to:</p>

		<ul class="privacy_policy_list">
			
			<li class="privacy_policy_list_items">Request that a business that collects a consumer's personal data disclose the categories and specific pieces of personal data that a business has collected about consumers.</li>

			<li class="privacy_policy_list_items">Request that a business delete any personal data about the consumer that a business has collected.</li>

			<li class="privacy_policy_list_items">Request that a business that sells a consumer's personal data, not sell the consumer's personal data.</li>
	...
	<h2 class="privacy_policy_subtitle">Account deletion</h2>

	<div class="privacy_policy_div">

		<p class="privacy_policy_content">If you choose to delete your account, all data and information that is currently linked to your account will be permanently deleted from our servers.</p>
