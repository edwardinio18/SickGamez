<?php
    ...
    if (isset($_POST['feedbackSubmit'])) {
    	...
    	if (empty($feedback)) {
    		...
    		$emptyFeedback = "The feedback box is empty!";
    		$errors = 1;
    	...
    	if ($errors == 0) {
    		...
    		$strippedTagsFeedback = strip_tags($feedback);
    
    		$to = "sssickgamezzz@gmail.com";
            $subject = "Feedback";
            $message = $strippedTagsFeedback;
            $headers = "From: SickGamer";
    
            if (mail($to, $subject, $message, $headers)) {
    
				$feedbackSubmitted = "Thank you for submitting your feedback!";
    
    	    	echo "<meta http-equiv='refresh' content='3; url=feedback' />";
    
        	} else {
    
				$feedbackNotSubmitted = "There was an error submitting your feedback! Please try again!";
				$errors = 1;
...
<body>
	...
	<h1 id="feedback_label">Feedback</h1>

	<p id="feedback_submitted"><?php echo $feedbackSubmitted; ?></p>

	<p id="feedback_not_submitted"><?php echo $feedbackNotSubmitted; ?></p>

	<p id="feedback_paragraph">Let us know what you would like to see added to SickGamez and we will do our very best to try and make it happen!</p>

	<form action="" method="post" style="text-align: center; margin-top: 3%;">

		<p id="feedback_required"><?php echo $emptyFeedback; ?></p>
		
		<textarea name="feedback" id="feedback" maxlength="400" placeholder="Let the ideas begin..." onfocus="this.placeholder = ''" onblur="this.placeholder = 'Let the ideas begin...'" <?php if ($errors == 1 && empty($feedback)) echo "style='border: 2.5px solid red;'"; ?> ></textarea>

		<br />

		<input type="submit" name="feedbackSubmit" id="feedbackSubmit" value="Leave feedback!" />
...
<script type="text/javascript">
  ...
  function openNav() {
	...
	setTimeout(function() {
		...
		$("#feedback_submitted").fadeOut(300);

	}, 2000);

	setTimeout(function() {

		$("#feedback_not_submitted").fadeOut(300);
